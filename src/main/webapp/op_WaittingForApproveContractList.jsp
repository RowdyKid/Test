        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form role="form" action="<%=request.getContextPath()%>/WaitingApproveContract?type=search"
                                  method="get">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="${pageContext.request.contextPath}/op_ApproveContract?contractid=<%=contract.GetId()%>">审批</a>
                                </td>
                            </tr>
                            <%}%>
                            <%--否则显示没有数据--%>
