...
<%--                                        <input class="form-control" readonly name="id" value="<%=user.getId()%>">--%>
                                        <input class="form-control" readonly name="id" value=1>
                                    </div>
...
<%--                                    <div class="form-group">--%>
<%--                                        <label>邮箱地址</label>--%>
<%--                                        <input class="form-control" readonly name="email" value="<%=user.getUseremail()%>">--%>
<%--                                    </div>--%>
                                    <div class="form-group">
                                        <label>新的密码</label>
<%--                                        <input class="form-control" name="password" value="<%=user.getPassword()%>">--%>
                                        <input class="form-control" name="password" value="1234">
                                    </div>
                                    <div class="form-group">
