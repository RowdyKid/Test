...
public class ClientManage extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (type == null) {
            ...
            Client client = (Client) (new ClientDAO().GetOneEntity(id));
            request.setAttribute("client", client);
            request.getRequestDispatcher("ad_ModifyCustomerInfo.jsp").forward(request, response);
            ...
            response.sendRedirect("ClientManage");
